        ...
        <div className={'counter-box'}>
            <div className={'counter-screen'}>
                ...
                <div className={'counter-batten-section'}>
                    <button onClick={handleIncrement} disabled={count >= maxValue}>
                        Increment
                    </button>
            ...
            {/*<hr/>*/}
            <span onClick={hiddenSettingsHandler}>
            ...
            </span>
            {
                showSettings && (
                    <div className={'counter-settings'}>
                        ...
                        <button onClick={handleSet} disabled={startValue >= maxValue || startValue < 0}>
                            Set
                        </button>
                    </div>
                )
...
//     const [maxValue, setMaxValue] = useState(10);
//     const [startValue, setStartValue] = useState(0);
//     const [invalidStartValue, setInvalidStartValue] = useState(false);
//     const [invalidMaxValue, setInvalidMaxValue] = useState(false);
//
//     useEffect(() => {
...
//             setMaxValue(parseInt(savedMaxValue, 10));
//             setStartValue(parseInt(savedStartValue, 10));
//             setCount(parseInt(savedStartValue, 10));
//         }
//     }, []);
//
//     useEffect(() => {
...
//
//         if (value <= startValue) {
//             setInvalidMaxValue(true);
//         } else {
//             setInvalidMaxValue(false);
//         }
//     };
//
//     const handleStartValueChange = (event: React.ChangeEvent<HTMLInputElement>) => {
...
//
//         if (value < 0) {
//             setInvalidStartValue(true);
//         } else {
//             setInvalidStartValue(false);
//         }
//     };
//
//     const handleSet = () => {
//         if (startValue < 0 || maxValue <= startValue) {
//             setInvalidStartValue(startValue < 0);
//             setInvalidMaxValue(maxValue <= startValue);
//             return;
//         }
//
//         setCount(startValue);
//     };
//
//     const isDisabled = count >= maxValue || invalidStartValue || invalidMaxValue;
//
//     return (
//         <div>
//             <div>
...
//                             value={maxValue}
//                             onChange={handleMaxValueChange}
//                             style={{ borderColor: invalidMaxValue ? 'red' : undefined }}
//                             disabled={false}
//                         />
//                     </label>
//                     {invalidMaxValue && <p>Invalid max value</p>}
//                 </div>
//                 <div>
//                     <label>
//                         Start Value:{' '}
...
//                             value={startValue}
//                             onChange={handleStartValueChange}
//                             style={{ borderColor: invalidStartValue ? 'red' : undefined }}
//                             disabled={isDisabled}
//                         />
//                     </label>
//                     {invalidStartValue && <p>Invalid start value</p>}
//                 </div>
//                 <button onClick={handleSet} disabled={isDisabled}>
//                     Set
//                 </button>
//             </div>
//         </div>
